...
class _CreateCompetitionViewState extends State<CreateCompetitionView> {
  ...
  /// Resets all input fields, controllers, and state variables to their defaults.
  void _resetForm() {
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: state is CreateCompetitionLoading
                            ? null
                            : _submit,
  ...
  void _submit() {
    ...
    if (_startDate == null || _endDate == null) {
      context.showError("Select dates");
      return;
    }
    ...
    if (_selectedType == "individual") {
      ...
      membersPerTeam = int.parse(_membersController.text);
